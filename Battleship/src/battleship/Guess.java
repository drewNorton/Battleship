...
public class Guess {
    ...
    public static boolean player(int guess) {
        ...
        if (PlaceShips.cLocations.contains(guess)) {
            ...
            if (index < 5) {
                CheckGame.player("carrier");
            } else if (index >= 5 && index < 9) {
                CheckGame.player("battleship");
            } else if (index >= 9 && index < 12) {
                CheckGame.player("cruiser");
            } else if (index >= 12 && index < 15) {
                CheckGame.player("submarine");
            } else if (index >= 15 && index < 17) {
                CheckGame.player("destroyer");
            }
            cpu();
            return true;
    ...
    public static void cpu() {
        ...
        if (PlaceShips.getpLocations().contains(guess)) {
            ...
            if (index < 5) {
                CheckGame.cpu("carrier", button);
            } else if (index >= 5 && index < 9) {
                CheckGame.cpu("battleship", button);
            } else if (index >= 9 && index < 12) {
                CheckGame.cpu("cruiser", button);
            } else if (index >= 12 && index < 15) {
                CheckGame.cpu("submarine", button);
            } else if (index >= 15 && index < 17) {
                CheckGame.cpu("destroyer", button);
            }
        } else {
